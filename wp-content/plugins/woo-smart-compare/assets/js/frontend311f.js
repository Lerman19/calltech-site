...
(function ($) {
  ...
  $(function () {
    ...
    if (woosc_vars.button_action === "show_message") {
      $.notiny.addTheme("woosc", { notification_class: "notiny-theme-woosc" });
    }
    woosc_quick_table();
  });
  ...
  $(document).on(
    "click touch",
    ".woosc_table .woosq-btn, .woosc_table .woosq-link",
    function (e) {
      e.preventDefault();
      woosc_close();
    }
  ...
  $(document).on(
    "click touch",
    ".woosc-sidebar .woosq-btn, .woosc-sidebar .woosq-link",
    function (e) {
      e.preventDefault();
      woosc_close_sidebar();
    }
  ...
  $(document).on("click touch", ".woosc-bar-share", function (e) {
    ...
    var data = { action: "woosc_share", nonce: woosc_vars.nonce };
  ...
  $(document).on("found_variation", function (e, t) {
    if (woosc_vars.variations === "yes") {
      ...
      $(".woosc-btn-" + product_id + ":not(.woosc-btn-has-icon)").html(
        woosc_vars.button_text
      );
  ...
  $(document).on("click touch", ".woosc-btn", function (e) {
    ...
    if ($this.hasClass("woosc-btn-added woosc-added")) {
      if (woosc_vars.click_again === "yes") {
        ...
        if (woosc_vars.button_action === "show_message") {
          $.notiny({
            ...
            image: product_image,
            text: woosc_vars.message_removed.replace(
              "{name}",
        ...
        if (woosc_vars.button_action === "show_message") {
          $.notiny({
            ...
            position: woosc_vars.message_position,
            image: product_image,
            text: woosc_vars.message_exists.replace(
              "{name}",
              "<strong>" + product_name + "</strong>"
            ),
          });
      ...
      if (woosc_vars.button_action === "show_message") {
        $.notiny({
          ...
          position: woosc_vars.message_position,
          image: product_image,
          text: woosc_vars.message_added.replace(
            "{name}",
            "<strong>" + product_name + "</strong>"
          ),
        });
    ...
    if (
      woosc_vars.button_action === "show_message" ||
  ...
  $(document).on(
    "click touch",
    ".woosc-sidebar-close, .woosc-sidebar-continue",
    function (e) {
      woosc_close_sidebar();
    }
  );
  ...
  $(document).on(
    "change",
    ".woosc-settings-field, .woosc-settings-tool",
    function () {
      woosc_save_settings();
    }
  );
    ...
    $(document).on("click touch", woosc_vars.open_button, function (e) {
      ...
      if (woosc_vars.open_button_action === "open_page") {
        ...
        if (woosc_vars.open_button_action === "open_sidebar") {
          if (
            !$(".woosc-sidebar-items").hasClass("woosc-sidebar-items-loaded")
          ) {
            woosc_load_data("sidebar");
          }
          woosc_open_sidebar();
  ...
  $(document).on(
    "click touch",
    ".woosc-menu-item a, .woosc-menu a",
    function (e) {
  ...
  function woosc_add_product(product_id) {
    ...
    if (limit) {
      $('.woosc-btn[data-id="' + product_id + '"]').removeClass(
        "woosc-btn-adding woosc-adding"
      );
      alert(limit_notice);
    } else {
  ...
  function woosc_check_buttons() {
    ...
    if (woosc_get_cookie(cookie_products) != "") {
      ...
      products.forEach(function (entry) {
        ...
        $(".woosc-btn-" + entry + ":not(.woosc-btn-has-icon)").html(
          woosc_vars.button_text_added
        );
    ...
    $(".woosc-menu-item").each(function () {
      if ($(this).hasClass("menu-item-type-woosc")) {
        ...
        $(this)
          ...
          .find("a")
          .wrapInner(
            '<span class="woosc-menu-item-inner" data-count="' +
              count +
              '"></span>'
          );
      }
