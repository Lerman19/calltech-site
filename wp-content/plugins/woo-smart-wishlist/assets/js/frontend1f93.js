...
(function ($) {
  ...
  $(function () {
    ...
    woosw_load_data();
    if (
      $(".woosw-custom-menu-item").length ||
      woosw_vars.reload_count === "yes"
    ) {
      woosw_load_count();
    }
    if (woosw_vars.button_action === "message") {
      $.notiny.addTheme("woosw", { notification_class: "notiny-theme-woosw" });
    }
  });
  ...
  $(document).on("click touch", ".woosw-btn", function (e) {
    ...
    if ($this.hasClass("woosw-added")) {
      ...
      $this
        ...
        .find(".woosw-btn-icon")
        .removeClass(
          woosw_vars.button_normal_icon + " " + woosw_vars.button_added_icon
        )
  ...
  $(document).on("click touch", ".woosw-manage", function (e) {
    e.preventDefault();
    woosw_popup_loading();
    var data = { action: "manage_wishlists", nonce: woosw_vars.nonce };
    $.post(woosw_vars.ajax_url, data, function (response) {
      woosw_wishlist_hide();
  ...
  $(document).on("click touch", "#woosw_add_wishlist", function (e) {
    ...
    var data = { action: "add_wishlist", name: name, nonce: woosw_vars.nonce };
    $.post(woosw_vars.ajax_url, data, function (response) {
      $("#woosw_manage").html(response);
      $("#woosw_wishlist").removeClass("woosw-loaded");
      woosw_popup_loaded();
  ...
  $(document).on("click touch", ".woosw-set-default", function (e) {
    ...
    woosw_popup_loading();
    var key = $(this).data("key");
    var data = { action: "set_default", key: key, nonce: woosw_vars.nonce };
    $.post(woosw_vars.ajax_url, data, function (response) {
      if (response.count != null) {
        woosw_change_count(response.count);
      }
  ...
  $(document).on("click touch", ".woosw-view-wishlist", function (e) {
    ...
    woosw_popup_loading();
    var key = $(this).data("key");
    var data = { action: "view_wishlist", key: key, nonce: woosw_vars.nonce };
    $.post(woosw_vars.ajax_url, data, function (response) {
      woosw_manage_hide();
  ...
  function woosw_wishlist_load() {
    var data = { action: "wishlist_load", nonce: woosw_vars.nonce };
    $.post(woosw_vars.ajax_url, data, function (response) {
      if (response.content != null) {
  ...
  function woosw_load_count() {
    var data = { action: "wishlist_load_count", nonce: woosw_vars.nonce };
    $.post(woosw_vars.ajax_url, data, function (response) {
      if (response.count != null) {
  ...
  function woosw_get_data() {
    var data = { action: "woosw_get_data", nonce: woosw_vars.nonce };
    $.post(woosw_vars.ajax_url, data, function (response) {
      if (response) {
        if ($storage) {
          sessionStorage.setItem(
            "woosw_data_" + response.key,
  ...
  function woosw_refresh_buttons(ids) {
    ...
    $.each(ids, function (key, value) {
      ...
      $(".woosw-btn-" + key + ":not(.woosw-btn-has-icon)").html(
      ...
      if (value.parent !== undefined) {
        ...
        $(".woosw-btn-" + value.parent + ":not(.woosw-btn-has-icon)").html(
          woosw_vars.button_text_added
        );
  ...
  function woosw_refresh_button_id(id) {
    $('.woosw-btn[data-id="' + id + '"]').removeClass(
      "woosw-btn-added woosw-added"
    );
    $('.woosw-btn[data-id="' + id + '"]:not(.woosw-btn-has-icon)').html(
